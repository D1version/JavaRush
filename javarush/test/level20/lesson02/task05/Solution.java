...
public class Solution {
    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            w.write(string1.number + "\n");
            w.write(string2.number + "\n");
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            Integer s1Number = Integer.parseInt(reader.readLine());
            Integer s2Number = Integer.parseInt(reader.readLine());
            reader.close();

            int temp = countStrings;

            countStrings = s1Number - 1;
            string1 = new String();
            countStrings = s2Number - 1;
            string2 = new String();
