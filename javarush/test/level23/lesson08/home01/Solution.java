...
public class Solution {
    ...
    public String getSelectFromClass(Class<? extends NamedItem> c) {
        return String.format("select * from %S", c.getSimpleName());
    }
    ...
    public List<Location> getLocations() {
        return new AbstractDbSelectExecutor<Location>() {
            ...
            public String getQuery() {
                return getSelectFromClass(((Class) ((ParameterizedType) this.getClass().
