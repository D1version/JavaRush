...
public class Solution {
    public static class AmigoThreadFactory implements ThreadFactory
    {
        ...
        {
            factoryNumber = new AtomicInteger(counter.incrementAndGet());
        ...
        public Thread newThread(Runnable r)
        {
            ...
            t.setName(String.format("%s-pool-%d-thread-%d", group.getName(), factoryNumber.get(), threadNumber.incrementAndGet()));
            return t;
        }
    }
